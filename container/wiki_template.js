...
(function (global) {
 ...
 function renderNotes(item) {
  ...
  // data-auto-edit="1" если изначально пусто → сразу откроем редактор
  const autoEdit = (item.value == null || String(item.value).trim() === '') ? '1' : '0';

  return `
    <!-- Notes (AT15) — как обычный meta, но с авто-редактированием при пустом значении -->
