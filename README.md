...
- любые изменения вносятся в рамках текущей архитектуры (любые улучшения архитектуры рассматриваются и при объективной необходимости внедряются, но не являются самоцелью)
